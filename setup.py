...
with open(os.path.join(here, 'flask_webhook.py'), encoding='utf-8') as f:
...
setuptools.setup(
    ...
    description='Create Flask application webhooks with attached handlers',
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com/Bogdan-Alexandrescu/Flask-Webhook',
